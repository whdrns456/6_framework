...
<body>
    ...
    <div class="outer">
            ...
            <div id="pagingArea">
                <ul class="pagination">
                    ...
                    <a href="#" class="page-link">Prev</a></li>
                 	...
                 	<c:otherwise>
                 	<li class="page-item">
                    <a href="list?cpage=${pi.currentPage -1}" class="page-link">Prev</a></li>
                 	</c:otherwise>
                 	</c:choose>
    	...
    	<script>
 		$(function(){
    	/*게시글 목록의 행을 클릭했을 때 detail 요청 */
    	$("#boardList>tbody>tr").click(function() {
			location.href = 'detail?bno=' + $(this).children(".bno").text();
			
			/*
				$(this) 현재 클릭된 요소를  jQuery 객체로 래핑합니다.
				.children(".bno") 현재 요소의 자식 중 .bno를 선택한다 
				.text() 선택된 자식 요소의 텍스트 내용을 가져온다. 
