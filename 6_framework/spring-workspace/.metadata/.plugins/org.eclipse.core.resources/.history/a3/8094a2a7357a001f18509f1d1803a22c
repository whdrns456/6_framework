            ...
            <form id="updateForm" method="post" action="update" enctype="multipart/form-data">
                ...
                <table align="center" class="table">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="boardTitle" id="title" class="form-control" value="${b.boardTitle }" required />
                        </td>
                    </tr>
                    <tr>
                        <th><label for="writer">작성자</label></th>
                        <td>
                            <input type="text" name="boardWriter" id="writer" class="form-control" value="${b.boardWriter}" readonly />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<%=request.getContextPath()%>/${b.changeName}" 
                            download="${b.originName}">${b.originName}</a>
                    ...
                    <tr>
                        <td colspan="2">
                            <textarea name="boardContent" id="content" class="form-control" rows="10" style="resize:none;" required> ${b.boardContent }</textarea>
                        </td>
                    </tr>
                </table>
                <br>
